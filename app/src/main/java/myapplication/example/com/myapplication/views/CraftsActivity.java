        ...
        navigation_view_left.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                if (id == R.id.home_page) {
                    Intent intent = new Intent(CraftsActivity.this,MainActivity.class);
                    startActivity(intent);
                }else if (id == R.id.active_page) {
                    Intent intent = new Intent(CraftsActivity.this,ActiveActivity.class);
                    startActivity(intent);
                }else if (id == R.id.craftw_page) {
                    Intent intent = new Intent(CraftsActivity.this,CraftwsActivity.class);
                    startActivity(intent);
                }else if (id == R.id.craft_tag_page) {
                    Intent intent = new Intent(CraftsActivity.this,CraftTagActivity.class);
                    startActivity(intent);
                }else if (id == R.id.leader_page) {
                    Intent intent = new Intent(CraftsActivity.this,LeaderActivity.class);
                    startActivity(intent);
                }
                return false;
            }
        });navigation_view_left.getMenu().findItem(R.id.craft_page).setChecked(true);
