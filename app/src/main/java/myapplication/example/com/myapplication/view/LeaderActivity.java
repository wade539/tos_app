...
public class LeaderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigation_view_left.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                if (id == R.id.home_page) {
                    ...
                    Intent intent = new Intent(LeaderActivity.this,ActiveActivity.class);
                    startActivity(intent);
                }else if (id == R.id.craft_page) {
                    Intent intent = new Intent(LeaderActivity.this,CraftsActivity.class);
                    startActivity(intent);
                }else if (id == R.id.craft_tag_page) {
                    Intent intent = new Intent(LeaderActivity.this,CraftTagActivity.class);
                    startActivity(intent);
                }else if (id == R.id.craftw_page) {
                    Intent intent = new Intent(LeaderActivity.this,CraftwsActivity.class);
                    startActivity(intent);
                }
                return false;
            }
        });navigation_view_left.getMenu().getItem(2).setChecked(true);
        // Set Data
        ...
        Cursor c=db.rawQuery("SELECT * FROM " + Active_Table, null);
        if (c.getCount()>0){
